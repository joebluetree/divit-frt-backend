...
{
    public class mast_history_config : IEntityTypeConfiguration<mast_history>
    {
        public void Configure(EntityTypeBuilder<mast_history> modelBuilder)
        {
            //Table
            modelBuilder.ToTable("mast_history");
