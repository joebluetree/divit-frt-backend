...
public interface IGenRemarkmRepository
{
    ...
    Task<gen_remarkm_dto> SaveAsync(int id, string parent_type,string mode, gen_remarkm_dto record);
    Task<gen_remarkm_dto> SaveParentAsync(int id, string mode, gen_remarkm_dto record);
    Task<gen_remarkm_dto> SaveDetailsAsync(int id, string parent_type,string mode, gen_remarkm_dto record);
