...
namespace UserAdmin.Controllers
{
    ...
    {
        private readonly IYearRepository mRepository;
        public YearController(IYearRepository _Repository)
        {
        ...
        [HttpPost]
        [Route("SaveAsync")]
        public async Task<IActionResult> SaveAsync(int id, string mode, [FromBody] mast_yearm_dto rec)
        {
            try
            {
