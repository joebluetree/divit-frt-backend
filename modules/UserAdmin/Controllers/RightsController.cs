...
namespace UserAdmin.Controllers
{
    ...
    {
        private readonly IRightsRepository mRepository;
        public RightsController(IRightsRepository _Repository)
        {
        ...
        [HttpPost]
        [Route("SaveAsync")]
        public async Task<IActionResult> SaveAsync(int id, string mode, [FromBody] rights_header_dto rec)
        {
            try
            {
