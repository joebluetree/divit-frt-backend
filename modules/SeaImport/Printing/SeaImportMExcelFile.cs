    ...
    public class ProcessSeaImportMExcelFile
    {
        ...
        private void CreateExcelData()
        {
            ...
            foreach (cargo_sea_importm_dto dr in Dt_List)
            {
                ...
                excel.CellValue(rowIndex, colIndex + 3, dr.mbl_agent_name!, new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 25 });
                excel.CellValue(rowIndex, colIndex + 4, "", new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 25 });
                excel.CellValue(rowIndex, colIndex + 5, dr.mbl_liner_name!, new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 25 });
        ...
        private int WriteHeader()
        {
            ...
            excel.CellValue(rowIndex, colIndex + 3, "MASTER AGENT", new CellFormat { Border = "A", Style = "B", FontSize = 10, ColumnWidth = 25});
