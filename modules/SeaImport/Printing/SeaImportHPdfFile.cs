...
namespace SeaImport.Printing
{
    public class SeaImportHPdfFile
    {
        ...
        private float WriteHeader(float _Row, float _Col)
        {
            ...
            pdf.AddText(LeftY, Col + Col_Head_data.Left , Col_Head_data.Width , Line_Height, DateType.ToUpper(), new TextFormat { Style = "B", FontSize = 10 });
            LeftY += Line_Height;
            ...
            RightY += Line_Height;
            pdf.AddText(RightY, RightCol , halfWidth, Line_Height, "CREATED BY", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(RightY, RightCol + Col_Column.Left, Col_Column.Width, Line_Height, ":", new TextFormat { Style = "B", FontSize = 10 });
