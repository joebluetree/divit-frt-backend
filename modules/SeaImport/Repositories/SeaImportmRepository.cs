    ...
    public class SeaImportmRepository : ISeaImportmRepository
    {
        ...
        public async Task<Dictionary<string, object>> GetListAsync(Dictionary<string, object> data)
        {
            try
            {
                ...
                var Records = await query.Select(e => new cargo_sea_importm_dto
                {
                    mbl_id = e.mbl_id,
        ...
        public async Task<cargo_sea_importm_dto?> GetRecordAsync(int id)
        {
            try
            {
                IQueryable<cargo_masterm> query = context.cargo_masterm;
                ...
                var Record = await query.Select(e => new cargo_sea_importm_dto
                {
                    ...
                    mbl_incoterm_name = e.incoterm!.param_name,
                    ...
                    mbl_status_id = e.mbl_status_id,
                    mbl_status_name = e.mblstatus!.param_name,
                    mbl_is_sea_waybill = e.mbl_is_sea_waybill,
                    mbl_ombl_sent_on = Lib.FormatDate(e.mbl_ombl_sent_on, Lib.outputDateFormat),
                    mbl_ombl_sent_ampm = e.mbl_ombl_sent_ampm,
                    mbl_of_sent_on = Lib.FormatDate(e.mbl_of_sent_on, Lib.outputDateFormat),
                    ...
                    mbl_devan_loc_id = e.mbl_devan_loc_id,
                    mbl_devan_loc_code = e.devanloc!.cust_code,
                    mbl_devan_loc_name = e.mbl_devan_loc_name,
                    mbl_devan_loc_add1 = e.mbl_devan_loc_add1,
                    mbl_devan_loc_add2 = e.mbl_devan_loc_add2,
        ...
        private Boolean AllValid(string mode, cargo_sea_importm_dto record_dto, ref string error)
        {
            Boolean bRet = true;
        ...
        public async Task<cargo_sea_importm_dto> SaveParentAsync(int id, string mode, cargo_sea_importm_dto record_dto)
        {
            ...
            try
            {
                ...
                Record.mbl_devan_loc_add3 = record_dto.mbl_devan_loc_add3;
                Record.mbl_devan_loc_add4 = record_dto.mbl_devan_loc_add4;
        ...
        public async Task<cargo_sea_importm_dto> saveCntrAsync(int id, string mode, cargo_sea_importm_dto record_dto)
        {
        ...
        public cargo_sea_importm_dto UpdateCntrCount(cargo_sea_importm_dto record_dto)
        {
            try
            {
        ...
        public async Task logHistory(cargo_masterm old_record, cargo_sea_importm_dto record_dto)
        {
            ...
            var old_record_dto = new cargo_sea_importm_dto
            {
                ...
                mbl_incoterm_name = old_record.incoterm?.param_name,
                ...
                mbl_devan_loc_code = old_record.devanloc?.cust_code,
                mbl_devan_loc_name = old_record.mbl_devan_loc_name,
                mbl_devan_loc_add1 = old_record.mbl_devan_loc_add1,
                mbl_devan_loc_add2 = old_record.mbl_devan_loc_add2,
                mbl_devan_loc_add3 = old_record.mbl_devan_loc_add3,
                mbl_devan_loc_add4 = old_record.mbl_devan_loc_add4,

            };

            await new LogHistorym<cargo_sea_importm_dto>(context)
        ...
        public async Task logHistoryCntrDetail(List<cargo_container> old_records, cargo_sea_importm_dto record_dto)
        {
