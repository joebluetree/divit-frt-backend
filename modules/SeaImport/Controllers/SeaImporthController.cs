...
{
    [Authorize]
    [Route("api/SeaImport/seaimporth")]
    public class SeaImporthController : Controller
    {
        private readonly ISeaImporthRepository mRepository;
        public SeaImporthController(ISeaImporthRepository Repository)
        {
        ...
        [HttpPost]
        [Route("SaveAsync")]
        public async Task<IActionResult> SaveAsync(int id, string mode, [FromBody] cargo_sea_importh_dto rec) 
        {
            try
            {
