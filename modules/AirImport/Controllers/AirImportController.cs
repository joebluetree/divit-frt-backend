...
namespace AirImport.Controllers
{
    ...
    [Authorize]
    [Route("api/Airimport")]
    public class AirImportController : Controller
    {
        private readonly IAirImportRepository mRepository;
        public AirImportController(IAirImportRepository Repository)
        {
