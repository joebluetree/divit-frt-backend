    ...
    public class ProcessSeaExportMExcelFile
    {
        ...
        private void CreateExcelData()
        {
            ...
            foreach (cargo_sea_exportm_dto dr in Dt_List)
            {
                ...
                excel.CellValue(rowIndex, colIndex + 1, Lib.FormatDate(Lib.ParseDate(dr.mbl_ref_date!), Lib.DisplayDateFormat), new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 10 });
                ...
                excel.CellValue(rowIndex, colIndex + 4, dr.mbl_liner_name!, new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 30 });
        ...
        private int WriteHeader()
        {
            ...
            rowIndex += 1;
            excel.CellValue(rowIndex, colIndex, "AGENT     :" + Agent, new CellFormat { FontSize = 10, ColumnWidth = 100, Merge = col_count });
            rowIndex += 1;
            excel.CellValue(rowIndex, colIndex, "PLACE OF RECIEPT      :" + POR, new CellFormat { FontSize = 10, ColumnWidth = 100, Merge = col_count });
            rowIndex += 1;
            excel.CellValue(rowIndex, colIndex, "PLACE OF DELIVERY     :" + POD, new CellFormat { FontSize = 10, ColumnWidth = 100, Merge = col_count });
            rowIndex += 1;
            ...
            excel.CellValue(rowIndex, colIndex + 4, "CARRIER", new CellFormat { Border = "A", Style = "B", FontSize = 10, ColumnWidth = 30 });
