...
{
    public class SeaExportMPdfFile
    {
        iPdfBase pdf = null!;
        ...
        private void Writedocument()
        {
            ...
            this.Col_Agent = new ColumnFormat { Left = 220, Width = 95};
            this.Col_Carrier = new ColumnFormat { Left = 315, Width = 85};
            this.Col_ShipType = new ColumnFormat { Left = 400, Width = 60};
            this.Col_Handled = new ColumnFormat { Left = 460, Width = 70};

            this.Col_Column = new ColumnFormat { Left = 105, Width = 10 };// ':' 
            this.Col_Head_data = new ColumnFormat { Left = 115, Width = 100 };
        ...
        private float WriteHeader(float _Row, float _Col)
        {
            ...
            LeftY += Line_Height;
            pdf.AddText(LeftY, Col, halfWidth, Line_Height, "REF #", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(LeftY, Col + Col_Column.Left, Col_Column.Width, Line_Height, ":", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(LeftY, Col + Col_Head_data.Left , Col_Head_data.Width , Line_Height, RefNo, new TextFormat { Style = "B", FontSize = 10 });
            
            float RightY = currentY;
            var RightCol = Col + halfWidth;
            pdf.AddText(RightY, RightCol , halfWidth, Line_Height, "AGENT", new TextFormat { Style = "B", FontSize = 10 });
            ...
            RightY += Line_Height;
            pdf.AddText(RightY, RightCol , halfWidth, Line_Height, "PLACE OF RECIEPT", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(RightY, RightCol + Col_Column.Left, Col_Column.Width, Line_Height, ":", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(RightY, RightCol + Col_Head_data.Left , Col_Head_data.Width , Line_Height, POR, new TextFormat { Style = "B", FontSize = 10 });
            RightY += Line_Height;
            pdf.AddText(RightY, RightCol , halfWidth, Line_Height, "PLACE OF DELIVERY", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(RightY, RightCol + Col_Column.Left, Col_Column.Width, Line_Height, ":", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(RightY, RightCol + Col_Head_data.Left , Col_Head_data.Width , Line_Height, POD, new TextFormat { Style = "B", FontSize = 10 });
