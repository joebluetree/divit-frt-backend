...
namespace Marketing.Printing
{
    public class QtnmLclPdfFile
    {
        ...
        private void Writedocument()
        {
            ...
            this.Col_date = new ColumnFormat { Left = 90, Width = 50 };
            this.Col_QuoteTo = new ColumnFormat { Left = 140, Width = 80};
            this.Col_QuoteBy = new ColumnFormat { Left = 220, Width = 60};
            this.Col_Pol = new ColumnFormat { Left = 280, Width = 50};
            this.Col_Pod = new ColumnFormat { Left = 330, Width = 50};
            this.Col_Move = new ColumnFormat { Left = 380, Width = 60};
            this.Col_Commodity = new ColumnFormat { Left = 440, Width = 90};
        ...
        private void CreateReport()
        {
            ...
            foreach (mark_qtnm_dto dr in Dt_List)
            {
                ...
                float PolHeight = pdf.MeasureWrappedTextHeight(Row, Col_Pol.Left, Col_Pol.Width, Line_Height, dr.qtnm_pol_name!, format);
                float PodHeight = pdf.MeasureWrappedTextHeight(Row, Col_Pod.Left, Col_Pod.Width, Line_Height, dr.qtnm_pod_name!, format);
                ...
                float rowHeight = new[] { CodeHeight, dateHeight, QuoteToHeight, QuoteByHeight, PolHeight, PodHeight, MoveHeight, CommodityHeight }.Max();
                ...
                pdf.AddText(Row, Col_Pol.Left, Col_Pol.Width, rowHeight, dr.qtnm_pol_name!, new TextFormat { Border = "LT" + BL, FontSize = 9, Indent = true });
                pdf.AddText(Row, Col_Pod.Left, Col_Pod.Width, rowHeight, dr.qtnm_pod_name!, new TextFormat { Border = "LT" + BL, FontSize = 9, Indent = true });
        ...
        private float WriteHeader(float _Row, float _Col)
        {
            ...
            pdf.AddText(currentY, Col_Pol.Left, Col_Pol.Width, Line_Height, "POL", new TextFormat { Border = "LT", Style = "B", FontSize = 10, Indent = true });
