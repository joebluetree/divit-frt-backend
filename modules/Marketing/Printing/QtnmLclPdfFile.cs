...
namespace Marketing.Printing
{
    public class QtnmLclPdfFile
    {
        ...
        private void Writedocument()
        {
            ...
            this.Col_date = new ColumnFormat { Left = 92, Width = 60 };
            this.Col_QuoteTo = new ColumnFormat { Left = 152, Width = 82};
            this.Col_QuoteBy = new ColumnFormat { Left = 234, Width = 60};
            this.Col_Pld = new ColumnFormat { Left = 294, Width = 98};
            this.Col_Move = new ColumnFormat { Left = 392, Width = 60};
        ...
        private float WriteHeader(float _Row, float _Col)
        {
            ...
            LeftY += Line_Height;
            pdf.AddText(LeftY, Col, halfWidth, Line_Height, "PLACE OF DELIVERY", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(LeftY, Col + Col_Column.Left, Col_Column.Width, Line_Height, ":", new TextFormat { Style = "B", FontSize = 10 });
            pdf.AddText(LeftY, Col + Col_Head_data.Left , Col_Head_data.Width , Line_Height, Quotepld, new TextFormat { Style = "B", FontSize = 10 });
