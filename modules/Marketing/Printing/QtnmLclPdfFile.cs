    ...
    public class QtnmLclPdfFile
    {
        ...
        private void CreateReport()
        {
            ...
            foreach (mark_qtnm_dto dr in Dt_List)
            {
                ...
                pdf.AddText(Row, Col_Pol.Left, Col_Pol.Width, Line_Height, dr.qtnm_pol_name!, new TextFormat { Border = "LT" + BL, FontSize = 9, Indent = true });
                pdf.AddText(Row, Col_Pod.Left, Col_Pod.Width, Line_Height, dr.qtnm_pod_name!, new TextFormat { Border = "LT" + BL, FontSize = 9, Indent = true });
