    ...
    public class ProcessExcelFile
    {
        ...
        private void CreateExcelData()
        {
            ...
            foreach (mark_qtnm_dto dr in Dt_List)
            {
                ...
                excel.CellValue(rowIndex, colIndex + 6, dr.qtnm_move_type!, new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 12 });
                excel.CellValue(rowIndex++, colIndex + 7, dr.qtnm_commodity!, new CellFormat { Border = "A", FontSize = 9, ColumnWidth = 20 });
            }
        ...
        private int WriteHeader()
        {
            ...
            rowIndex += 1;
            excel.CellValue(rowIndex, colIndex, "PLACE OF DELIVERY    :" + Quotepld, new CellFormat { FontSize = 10, ColumnWidth = 100, Merge = col_count });
            rowIndex += 1;
            ...
            excel.CellValue(rowIndex, colIndex + 6, "MOVE", new CellFormat { Border = "A", Style = "B", FontSize = 10, ColumnWidth = 12 });
            excel.CellValue(rowIndex, colIndex + 7, "COMMODITY", new CellFormat { Border = "A", Style = "B", FontSize = 10, ColumnWidth = 20 });
            rowIndex += 1;
            return rowIndex;
        }
