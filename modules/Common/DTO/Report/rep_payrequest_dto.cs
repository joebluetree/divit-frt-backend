...
{
    public class rep_payrequest_dto : basetable_dto
    {
        ...
        public int? cp_inv_hid { get; set; } = 0;
        public string? cp_checkcopy { get; set; } = "";
        public string? cp_approval { get; set; } = "";
        public string? cp_arap { get; set; } = "";
        public string? cp_attachment { get; set; } = "";
        public int? su_id { get; set; } = 0;
        public int? su_parent_id { get; set; } = 0;
        public string? su_parent_type { get; set; } = "";
        public string? su_ref_no { get; set; } = "";
        ...
        public List<rep_payrequest_dto>? cp_details { get; set; } 
    }
}
