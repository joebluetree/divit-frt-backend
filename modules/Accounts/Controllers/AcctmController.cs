...
{
    [Authorize]
    [Route("api/Accounts/Acctm")]
    public class AcctmController : Controller
    {
        private readonly IAcctmRepository mRepository;
        public AcctmController(IAcctmRepository _Repository)
        {
        ...
        [HttpPost]
        [Route("SaveAsync")]
        public async Task<IActionResult> SaveAsync(int id, string mode , [FromBody] acc_acctm_dto rec)
        {
            try
            {
