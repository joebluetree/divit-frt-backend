...
{
    public class HouseProfitSummaryExcelFile
    {
        ...
        public HouseProfitSummaryExcelFile()
        {
            excel = new TextExcel();
        }
        ...
        private void CreateExcelData()
        {
            ...
            foreach (rep_houseprofit_dto dr in Dt_List)
            {
                ...
                if (Format == "AGENT" && LastRow)
                    excel.CellValue(rowIndex, colIndex + 0, "TOTAL", new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                if (Format == "SHIPPER")
                    excel.CellValue(rowIndex, colIndex + 0, dr.mbl_shipper_name!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                if (Format == "CONSIGNEE")
                    excel.CellValue(rowIndex, colIndex + 0, dr.mbl_consignee_name!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                if (Format == "NOMINATION")
                    excel.CellValue(rowIndex, colIndex + 0, dr.mbl_bltype!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                if (Format == "CLIENT TYPE")
                    excel.CellValue(rowIndex, colIndex + 0, dr.mbl_agent_bltype!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                if (Format == "HANDLED-BY")
                    excel.CellValue(rowIndex, colIndex + 0, dr.mbl_handled_name!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, WrapText = true, VAlign = "T" });
                ...
                excel.CellValue(rowIndex, colIndex + 2, dr.mbl_house_count!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, HAlign = "R", VAlign = "T" });
                ...
                excel.CellValue(rowIndex, colIndex + 6, dr.mbl_teu!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, HAlign = "R", VAlign = "T" });
                excel.CellValue(rowIndex, colIndex + 7, dr.mbl_cbm!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, HAlign = "R", VAlign = "T" });
                excel.CellValue(rowIndex++, colIndex + 8, dr.mbl_weight!, new CellFormat { Border = TotalBorder + BL, Style = TotalStyle + ST, FontSize = 9, HAlign = "R", VAlign = "T" });
        ...
        private int WriteHeader(int rowIndex, int colIndex)
        {
            ...
            if (Format == "SHIPPER")
                excel.CellValue(rowIndex, colIndex + 0, "SHIPPER", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 40 });
            if (Format == "CONSIGNEE")
                excel.CellValue(rowIndex, colIndex + 0, "CONSIGNEE", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 40 });
            if (Format == "NOMINATION")
                excel.CellValue(rowIndex, colIndex + 0, "NOMINATION", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 40 });
            if (Format == "CLIENT TYPE")
                excel.CellValue(rowIndex, colIndex + 0, "CLIENT-TYPE", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 40 });
            if (Format == "HANDLED-BY")
                excel.CellValue(rowIndex, colIndex + 0, "HANDLED-BY", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 40 });
            ...
            excel.CellValue(rowIndex, colIndex + 6, "TEU", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 10, HAlign = "R" });
            excel.CellValue(rowIndex, colIndex + 7, "CBM", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 10, HAlign = "R" });
            excel.CellValue(rowIndex, colIndex + 8, "WEIGHT", new CellFormat { Border = "TB", Style = "B", FontSize = 10, ColumnWidth = 12, HAlign = "R" });
