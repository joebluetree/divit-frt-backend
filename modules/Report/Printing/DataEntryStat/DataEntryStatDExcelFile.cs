...
{
    public class DataEntryStatDExcelFile
    {
        ...
        private int MaxCount = 39;
        public DataEntryStatDExcelFile()
        {
            excel = new TextExcel();
        }
        ...
        private void CreateExcelData()
        {
            ...
            foreach (rep_dataentrystat_dto dr in Dt_List)
            {
                ...
                excel.CellValue(rowIndex, colIndex + 0, dr.mbl_mode!, excel.GetCellFormat(Border:BL));
                excel.CellValue(rowIndex, colIndex + 1, dr.mbl_refno!, excel.GetCellFormat(Border:BL));
                excel.CellValue(rowIndex, colIndex + 2, mbl_ref_date.ToUpper(), excel.GetCellFormat(Border:BL));
                excel.CellValue(rowIndex, colIndex + 3, dr.mbl_no!, excel.GetCellFormat(Border:BL));
                excel.CellValue(rowIndex, colIndex + 4, dr.mbl_house_nos!, excel.GetCellFormat(Border:BL));
                excel.CellValue(rowIndex++, colIndex + 5, dr.rec_created_by!, excel.GetCellFormat(Border:BL));
        ...
        private int WriteHeader(int rowIndex, int colIndex)
        {
            ...
            excel.CellValue(rowIndex, colIndex + 2, "CATEGORY", new CellFormat { Style = "B", FontSize = 10 });
            excel.CellValue(rowIndex, colIndex + 3, Category, new CellFormat { Style = "B", FontSize = 10 });
            rowIndex += 1;
            ...
            rowIndex += 1;
            excel.CellValue(rowIndex, colIndex + 0, "GROUP", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:20 ));
            excel.CellValue(rowIndex, colIndex + 1, "REF#", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:20 ));
            excel.CellValue(rowIndex, colIndex + 2, "REF-DATE", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:20 ));
            excel.CellValue(rowIndex, colIndex + 3, "MASTER#", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:25 ));
            excel.CellValue(rowIndex, colIndex + 4, "HOUSE#", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:30 ));
            excel.CellValue(rowIndex, colIndex + 5, "CREATED-BY", excel.GetCellFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:25 ));
