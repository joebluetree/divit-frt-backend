...
{
    public class ShipmentLogF3ExcelFile
    {
        ...
        private void CreateExcelData()
        {
            ...
            foreach (rep_shipmentlog_dto dr in Dt_List)
            {
                ...
                excel.CellValue(rowIndex, colIndex + 3, dr.mbl_shipper_name!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 4, dr.mbl_consignee_name!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 5, dr.mbl_cntr_type!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 6, dr.mbl_packages!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 7, dr.mbl_place_final!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 8, mbl_etd!.ToUpper(), GetFormat());
                excel.CellValue(rowIndex, colIndex + 9, dr.mbl_paid_status!, GetFormat());
                excel.CellValue(rowIndex, colIndex + 10, mbl_eta!.ToUpper(), GetFormat());
                excel.CellValue(rowIndex++, colIndex + 11, mbl_lfd!.ToUpper(), GetFormat());
            }
        ...
        private int WriteHeader(int rowIndex, int colIndex)
        {
            ...
            excel.CellValue(rowIndex, colIndex + 3, "SHIPPER", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:35 ));
            excel.CellValue(rowIndex, colIndex + 4, "CONSIGNEE", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:35 ));
            excel.CellValue(rowIndex, colIndex + 5, "TYPE", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:15 ));
            excel.CellValue(rowIndex, colIndex + 6, "PKGS", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:15 ));
            excel.CellValue(rowIndex, colIndex + 7, "FINAL DESTINATION", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:20 ));
            excel.CellValue(rowIndex, colIndex + 8, "ETD", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:15 ));
            excel.CellValue(rowIndex, colIndex + 9, "CLIENT PAID", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:25 ));
            excel.CellValue(rowIndex, colIndex + 10, "ETA", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:15 ));
            excel.CellValue(rowIndex, colIndex + 11, "LFD", GetFormat( Border:"TB", Style:"B", FontSize:10, ColumnWidth:15 ));
