...
{
    public class ShipmentLogF1PdfFile
    {
        iPdfBase pdf = null!;
        ...
        private void CreateReport()
        {
            ...
            foreach (rep_shipmentlog_dto dr in Dt_List)
            {
                ...
                if(OpGroup == "SEA EXPORT")
                {
                    ...
                    pdf.AddText(Row, Col_BookingNo.Left, Col_BookingNo.Width, rowHeight, dr.mbl_liner_bookingno!, new TextFormat { Border = "b" + BL, Style = "" + ST, FontSize = detFontSize, Indent = true });
        ...
        private float WriteHeader(float _Row, float _Col)
        {
            ...
            {   
                ...
                this.Col_ShipStage = new ColumnFormat { Left = 190, Width = 110 };
                this.Col_Carrier = new ColumnFormat { Left = 300, Width = 130 };
                this.Col_BookingNo = new ColumnFormat { Left = 430, Width = 90 };
                this.Col_Consignee = new ColumnFormat { Left = 520, Width = 190 };
                this.Col_CntrType = new ColumnFormat { Left = 710, Width = 60 };
                ...
                pdf.AddText(currentY, Col_BookingNo.Left, Col_BookingNo.Width, Line_Height, "BOOKING #", new TextFormat { Border = "TB", Style = "B", FontSize = hedFontSize, Indent = true });
            ...
            if(OpGroup == "SEA IMPORT")
            {
                ...
                this.Col_HouseNo = new ColumnFormat { Left = 100, Width = 90 };
                this.Col_ShipStage = new ColumnFormat { Left = 190, Width = 110 };
                this.Col_Carrier = new ColumnFormat { Left = 300, Width = 200 };
                this.Col_Consignee = new ColumnFormat { Left = 500, Width = 210 };
                this.Col_CntrType = new ColumnFormat { Left = 710, Width = 60 };
                this.Col_ETA = new ColumnFormat { Left = 770, Width = 60 };
            ...
            if(OpGroup == "AIR EXPORT" || OpGroup == "AIR IMPORT" || OpGroup == "OTHERS")
            {
                this.Col_RefNo = new ColumnFormat { Left = 30, Width = 80 };
                this.Col_HouseNo = new ColumnFormat { Left = 110, Width = 100 };
                this.Col_ShipStage = new ColumnFormat { Left = 210, Width = 160 };
                this.Col_Carrier = new ColumnFormat { Left = 370, Width = 180 };
                this.Col_Consignee = new ColumnFormat { Left = 550, Width = 200};
                this.Col_ETA = new ColumnFormat { Left = 750, Width = 80 };
