...
{
    [Authorize]
    [Route("api/Report/shipmentclose")]
    public class ShipmentCloseController : Controller
    {
        private readonly IShipmentCloseRepository mRepository;
        public ShipmentCloseController(IShipmentCloseRepository Repository)
        {
