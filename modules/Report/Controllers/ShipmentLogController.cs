...
{
    [Authorize]
    [Route("api/Report/shipmentlog")]
    public class ShipmentLogController : Controller
    {
        private readonly IShipmentLogRepository mRepository;
        public ShipmentLogController(IShipmentLogRepository Repository)
        {
