...
{
    [Authorize]
    [Route("api/Report/itshipment")]
    public class ITShipmentController : Controller
    {
        private readonly IITShipmentRepository mRepository;
        public ITShipmentController(IITShipmentRepository Repository)
        {
