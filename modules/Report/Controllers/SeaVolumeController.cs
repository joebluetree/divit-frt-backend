...
{
    [Authorize]
    [Route("api/Report/seavolume")]
    public class SeaVolumeController : Controller
    {
        private readonly ISeaVolumeRepository mRepository;
        public SeaVolumeController(ISeaVolumeRepository Repository)
        {
