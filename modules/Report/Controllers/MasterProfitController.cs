...
{
    [Authorize]
    [Route("api/Report/masterprofit")]
    public class MasterProfitController : Controller
    {
        private readonly IMasterProfitRepository mRepository;
        public MasterProfitController(IMasterProfitRepository Repository)
        {
