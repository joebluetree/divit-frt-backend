...
namespace Masters.Controllers
{
    ...
    {
        private readonly ICustomermRepository mRepository;
        public CustomerController(ICustomermRepository Repository)
        {
        ...
        [HttpPost]
        [Route("SaveAsync")]
        public async Task<IActionResult> SaveAsync(int id, string mode, [FromBody] mast_customerm_dto rec)
        {
            try
            {
